...
public class DirAdapter extends BaseAdapter {
    ...
    public DirAdapter(Context context, ArrayList<HomeList> homeList) {
        ...
        Bitmap bm=BitmapFactory.decodeResource(context.getResources(),R.drawable.background,options);
    }
