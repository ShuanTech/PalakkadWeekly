...
public abstract class SlidingTabIndicationInterpolator {

    public static final SlidingTabIndicationInterpolator SMART = new SmartIndicationInterpolator();
    public static final SlidingTabIndicationInterpolator LINEAR = new LinearIndicationInterpolator();

    static final int ID_SMART = 0;
    static final int ID_LINEAR = 1;

    public static SlidingTabIndicationInterpolator of(int id) {
        switch (id) {
            case ID_SMART:
                return SMART;
            case ID_LINEAR:
    ...
    public static class SmartIndicationInterpolator extends SlidingTabIndicationInterpolator {
    ...
    public static class LinearIndicationInterpolator extends SlidingTabIndicationInterpolator {
